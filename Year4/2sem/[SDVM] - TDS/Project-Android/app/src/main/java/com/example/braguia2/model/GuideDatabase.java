...
@Database(entities = {Trail.class, User.class, App.class, Contacts.class, Partners.class, Socials.class, Edge.class, Ponto.class, Conteudo.class, RelPin.class}, version = 971)
