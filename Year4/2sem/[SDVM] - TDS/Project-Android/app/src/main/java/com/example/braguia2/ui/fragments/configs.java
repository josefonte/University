...
public class configs extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout btn_location = view.findViewById(R.id.location_btn);
        ImageView btn_back = view.findViewById(R.id.go_back);

        btn_back.setOnClickListener(v -> {
            Navigation.findNavController(view).navigate(R.id.action_configs_to_perfil_fragment);
        });

        btn_location.setOnClickListener(v ->
        {
            Navigation.findNavController(view).navigate(R.id.action_configs_to_config_location);
